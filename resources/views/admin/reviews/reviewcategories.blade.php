                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content d-flex justify-content-between">
                                                <h4 class="title nk-block-title">Add Reviews Categories</h4>
                                                {{ Breadcrumbs::render('reviews-category') }}
                                            </div>
                                        </div>
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="row gy-4">
                                                    <form action="{{ route('add-reviews-categories') }}" method="post">
                                                        @csrf
                                                    <div class="col-sm-6">
                                                ...
                                                <thead class="tb-odr-head">
                                                    <tr class="tb-odr-item">
                                                        ...
                                                        <th class="tb-odr-amount">
                                                            <span class="tb-odr-total">Show on Home Page</span>
                                                    ...
                                                    <tr class="tb-odr-item">
                                                        ...
                                                        <td>
                                                                <div class="custom-control custom-switch">
                                                                    <input type="radio" name="home_page_status" value="{{ $category->id ?? '' }}" class="custom-control-input" id="customSwitch{{ $category->id ?? '' }}" @if($category->home_status == 1) checked @endif>
                                                            ...
                                                            <div class="dropdown">
                                                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                                                    <ul class="link-list-plain">
                                                                        ...
                                                                        <li><a link="{{ url('admin-dashboard/reviews-categories/delete/'.$category->id) }}" class="text-danger remove">Remove</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </td>
...
<script>
    ...
    $('input[name="home_page_status"]').on('change',function(){
        ...
        $.ajax({
            method: 'post',
            url: '{{ route('add-reviews-categories') }}',
            data: { _token:'{{ csrf_token() }}',id:id,action:'change_home_status' },
            dataType: 'json',
