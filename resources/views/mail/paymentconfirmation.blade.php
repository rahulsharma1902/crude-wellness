                            ...
                            <td class="py-5">
                                <table class="email-body text-center">
                                    <tbody>
                                        ...
                                        @if($mailData['invoice_url'] == 'active')
                                            <tr>
                                                <td class="px-3 px-sm-5 pb-3 pb-sm-5">
                                                    <h5 class="text-primary mb-3">Congratulation! You payment is successfully completed check invoice below button</h5>
                                            ...
                                            <tr>
                                                <td class="px-3 px-sm-5 pb-3 pb-sm-5">
                                                    <h5 class="text-primary mb-3">Your payment is process is pending complete it by click below link!</h5>
