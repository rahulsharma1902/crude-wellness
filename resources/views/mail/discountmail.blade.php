                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td class="px-3 px-sm-5 pb-3 pb-sm-5">
                                                    <h5 class="text-primary mb-3">Congratulation! You got a new coupon use this to buy our new product.This coupon is valid for till tomorrow.</h5>
                                                   <p class="text-center">Discount Code: {{ $mailData['discount_code'] ?? '' }}</p>
                                                </td>
                                            </tr>
